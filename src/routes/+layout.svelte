			...
			<AppBar>
				...
				<svelte:fragment slot="trail">
					<nav class="list-nav" aria-label="Main navigation">
						...
						>
							{#each [{ name: 'About', href: '/about' }, { name: 'Professionals', href: '/professionals' }, { name: 'Family Services', href: '/families' }, { name: 'Events', href: '/events' }, { name: 'Volunteer', href: '/volunteer' }, { name: 'Contact Us', href: '/contact' }] as { name, href }}
								<li>
									<a {href}>
